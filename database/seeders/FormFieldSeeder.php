    ...
    public function run(): void
    {
        ...
        if ($veneer) {
            ...
            $veneer->fields()->createMany([
                [
                    'type' => 'section',
                    'label_ar' => 'الغرض من الإجراء',
                    'label_en' => 'Purpose of the Procedure',
                    'content_ar' => 'تركيب القشور الخزفية يهدف إلى تحسين المظهر الجمالي للأسنان من خلال تغطية السطح الأمامي للأسنان بقشور رقيقة مصنوعة من الخزف أو المواد المركبة.',
                    'content_en' => 'Applying porcelain veneers aims to improve the cosmetic appearance of teeth by covering the front surface of the teeth with thin shells made of porcelain or composite materials.',
                    'sort_order' => 10,
                ],
                [
                    'type' => 'instruction',
                    'label_ar' => 'خطوات الإجراء',
                    'label_en' => 'Procedure Steps',
                    'options' => [
                        ['label_ar' => 'تحضير السن عن طريق إزالة كمية صغيرة من المينا لتلائم القشرة الخزفية.', 'label_en' => 'Preparing the tooth by removing a small amount of enamel to fit the veneer.'],
                        ['label_ar' => 'أخذ طبعة (قالب) للأسنان لإرسالها إلى المختبر لتصنيع القشور الخزفية.', 'label_en' => 'Taking an impression (mold) of the teeth to send to the lab for veneer fabrication.'],
                        ['label_ar' => 'تركيب قشور مؤقتة لحماية الأسنان حتى يتم تصنيع القشور الدائمة.', 'label_en' => 'Placing temporary veneers to protect the teeth until permanent veneers are fabricated.'],
                        ['label_ar' => 'تركيب القشور الخزفية الدائمة بعد الانتهاء من تصنيعها.', 'label_en' => 'Placing the permanent porcelain veneers once fabrication is complete.'],
                    ],
                    'settings' => ['list_type' => 'numbered'],
                    'sort_order' => 20,
                ],
                [
                    'type' => 'instruction',
                    'label_ar' => 'الفوائد المتوقعة',
                    'label_en' => 'Expected Benefits',
                    'options' => [
                        ['label_ar' => 'تحسين المظهر الجمالي للأسنان.', 'label_en' => 'Improving the cosmetic appearance of teeth.'],
                        ['label_ar' => 'تصحيح عيوب مثل التصبغات، الفراغات، أو التشوهات البسيطة.', 'label_en' => 'Correcting defects such as discoloration, gaps, or minor malformations.'],
                        ['label_ar' => 'نتائج طبيعية المظهر ومقاومة للتلون.', 'label_en' => 'Natural-looking results and resistance to staining.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 30,
                ],
                [
                    'type' => 'instruction',
                    'label_ar' => 'المخاطر والمضاعفات المحتملة',
                    'label_en' => 'Risks and Potential Complications',
                    'options' => [
                        ['label_ar' => 'حساسية مؤقتة في الأسنان بعد الإجراء.', 'label_en' => 'Temporary tooth sensitivity after the procedure.'],
                        ['label_ar' => 'احتمالية حدوث كسر أو تلف في القشور الخزفية.', 'label_en' => 'Potential breakage or damage to the porcelain veneers.'],
                        ['label_ar' => 'احتمالية حدوث التهاب أو عدوى في حال عدم الالتزام بتعليمات العناية الفموية.', 'label_en' => 'Potential for inflammation or infection if oral care instructions are not followed.'],
                        ['label_ar' => 'احتمالية الحاجة إلى إعادة العلاج في المستقبل.', 'label_en' => 'Potential need for retreatment in the future.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 40,
                ],
                [
                    'type' => 'instruction',
                    'label_ar' => 'البدائل المتاحة',
                    'label_en' => 'Available Alternatives',
                    'options' => [
                        ['label_ar' => 'تبييض الأسنان لتحسين اللون.', 'label_en' => 'Tooth whitening to improve color.'],
                        ['label_ar' => 'استخدام الحشوات التجميلية لإصلاح العيوب البسيطة.', 'label_en' => 'Using cosmetic fillings to repair minor defects.'],
                        ['label_ar' => 'تقويم الأسنان لتصحيح الفراغات أو الازدحام.', 'label_en' => 'Orthodontics to correct gaps or crowding.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 50,
                ],
                [
                    'type' => 'instruction',
                    'label_ar' => 'التزامات المريض',
                    'label_en' => 'Patient Obligations',
                    'options' => [
                        ['label_ar' => 'الالتزام بتعليمات العناية الفموية بعد الإجراء.', 'label_en' => 'Commitment to oral care instructions after the procedure.'],
                        ['label_ar' => 'تجنب العادات التي قد تؤدي إلى تلف القشور (قضم الأظافر، فتح الأشياء بالأسنان).', 'label_en' => 'Avoiding habits that may damage veneers (nail biting, opening objects with teeth).'],
                        ['label_ar' => 'الحضور لجميع المواعيد المحددة للمتابعة.', 'label_en' => 'Attending all scheduled follow-up appointments.'],
                        ['label_ar' => 'إبلاغ الطبيب بأي أعراض غير طبيعية بعد الإجراء.', 'label_en' => 'Informing the doctor of any abnormal symptoms after the procedure.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 60,
                ],
                ...
                [
                    ...
                    'content_ar' => 'أقر بأنني قد تلقيت شرحاً مفصلاً عن الإجراء وفهمت جميع الجوانب المتعلقة به، وأتيحت لي الفرصة لطرح الأسئلة، وأوافق على إجراء تركيب القشور الخزفية (الفينير).',
                    'content_en' => 'I acknowledge that I have received a detailed explanation of the procedure, understood all aspects related to it, been given the opportunity to ask questions, and consent to the porcelain veneers procedure.',
                    'sort_order' => 100,
                ],
                [
                    'type' => 'signature',
        ...
        if ($crown_rct) {
            ...
            $crown_rct->fields()->createMany([
                [
                    ...
                    'label_ar' => 'الغرض من الإجراء',
                    'label_en' => 'Purpose of the Procedure',
                    'content_ar' => 'تركيب تاج زركون أو إيماكس يهدف إلى استعادة شكل ووظيفة السن بعد علاج الجذور، وحمايته من التلف أو الكسر في المستقبل. ومع ذلك، نظراً لأن علاج الجذور تم خارج العيادة، قد تكون هناك معلومات محدودة عن حالة الجذور والأنسجة المحيطة.',
                    'content_en' => 'Placing a zirconia or emax crown aims to restore the shape and function of the tooth after root canal treatment (RCT), and protect it from damage or breakage in the future. However, since the root canal treatment was performed elsewhere, there may be limited information about the status of the roots and surrounding tissues.',
                    'sort_order' => 10,
                ],
                [
                    'type' => 'instruction',
                    ...
                    'label_en' => 'Procedure Steps',
                    'options' => [
                        ['label_ar' => 'فحص السن وتقييم حالة علاج الجذور السابق.', 'label_en' => 'Examining the tooth and evaluating the state of the previous root canal treatment.'],
                        ['label_ar' => 'تحضير السن عن طريق إزالة جزء من المينا لتلائم التاج.', 'label_en' => 'Preparing the tooth by removing a portion of enamel to fit the crown.'],
                        ['label_ar' => 'أخذ طبعة (قالب) للسن لإرسالها إلى المختبر لتصنيع التاج.', 'label_en' => 'Taking an impression (mold) of the tooth to send to the lab for crown fabrication.'],
                        ['label_ar' => 'تركيب تاج الزركون أو الإيماكس الدائم بعد الانتهاء من تصنيعه.', 'label_en' => 'Placing the permanent zirconia or emax crown once fabrication is complete.'],
                    ],
                    'settings' => ['list_type' => 'numbered'],
                    'sort_order' => 20,
                ],
                [
                    ...
                    'label_en' => 'Expected Benefits',
                    'options' => [
                        ['label_ar' => 'استعادة وظيفة المضغ والابتسامة.', 'label_en' => 'Restoring chewing function and smile.'],
                        ['label_ar' => 'حماية السن من التلف أو الكسر.', 'label_en' => 'Protecting the tooth from damage or breakage.'],
                        ['label_ar' => 'تحسين المظهر الجمالي للسن.', 'label_en' => 'Improving the cosmetic appearance of the tooth.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 30,
                ],
                [
                    ...
                    'label_en' => 'Risks and Potential Complications',
                    'options' => [
                        ['label_ar' => 'حساسية مؤقتة في السن بعد الإجراء.', 'label_en' => 'Temporary sensitivity in the tooth after the procedure.'],
                        ['label_ar' => 'احتمالية حدوث التهاب أو عدوى في حال عدم الالتزام بتعليمات العناية الفموية.', 'label_en' => 'Potential for inflammation or infection if oral care instructions are not followed.'],
                        ['label_ar' => 'احتمالية الحاجة إلى إعادة العلاج في المستقبل.', 'label_en' => 'Potential need for retreatment in the future.'],
                        ['label_ar' => 'احتمالية وجود مشاكل غير مكتشفة في علاج الجذور السابق قد تؤثر على نجاح التاج.', 'label_en' => 'Potential undetected issues in the previous root canal treatment that could affect crown success.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 40,
                ],
                [
                    'type' => 'note',
                    'label_ar' => 'التكهن الطبي',
                    'label_en' => 'Medical Prognosis',
                    'content_ar' => 'نظراً لأن علاج الجذور تم خارج العيادة، قد تكون هناك معلومات محدودة عن حالة الجذور والأنسجة المحيطة. قد يؤثر ذلك على نجاح الإجراء وعمر التاج.',
                    'content_en' => 'Since the root canal treatment was performed elsewhere, there may be limited information about the status of the roots and surrounding tissues. This may affect the success of the procedure and lifespan of the crown.',
                    'sort_order' => 50,
                ],
                [
                    'type' => 'instruction',
                    ...
                    'label_en' => 'Available Alternatives',
                    'options' => [
                        ['label_ar' => 'تركيب تاج من مواد أخرى (مثل المعدن أو البورسلين).', 'label_en' => 'Placing a crown of other materials (such as metal or porcelain).'],
                        ['label_ar' => 'عدم تركيب تاج، مع العلم أن ذلك قد يؤدي إلى تلف السن.', 'label_en' => 'Not placing a crown, noting that this may lead to tooth damage.'],
                        ['label_ar' => 'خلع السن واستبداله ببديل آخر (مثل زراعة الأسنان).', 'label_en' => 'Extracting the tooth and replacing it with another alternative (such as dental implants).'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 60,
                ],
                ...
                [
                    'type' => 'text',
                    'key' => 'rct_tooth_number',
                    'label_ar' => 'رقم السن / الضرس المستهدف',
                    'label_en' => 'Tooth / Jaw Location Number',
                    'placeholder_ar' => 'مثال: 16',
                    'placeholder_en' => 'e.g. 16',
                    'is_required' => true,
                    'settings' => ['width' => 'full'],
                    'sort_order' => 100,
                ],
                [
                    ...
                    'content_ar' => 'أقر بأنني تلقيت شرحاً كافياً عن الإجراء وفهمت جميع الجوانب المتعلقة به، وأدرك أن علاج الجذور تم خارج العيادة وقد تكون هناك معلومات محدودة عن حالة السن، وأوافق على إجراء تركيب تاج زركون أو إيماكس.',
                    'content_en' => 'I acknowledge that I have received a sufficient explanation of the procedure and understood all aspects related to it. I realize that the root canal treatment was performed outside the clinic and there may be limited information about the tooth condition, and I agree to place a zirconia or emax crown.',
                    'sort_order' => 110,
                ],
                [
                    'type' => 'signature',
        ...
        if ($crown_implant) {
            ...
            $crown_implant->fields()->createMany([
                [
                    ...
                    'label_ar' => 'الغرض من الإجراء',
                    'label_en' => 'Purpose of the Procedure',
                    'content_ar' => 'تركيب تاج على زرعة أسنان يهدف إلى استعادة شكل ووظيفة السن المفقود. ومع ذلك، نظراً لأن الزرعة تم تركيبها خارج العيادة، قد تكون هناك معلومات محدودة عن حالة الزرعة والأنسجة المحيطة.',
                    'content_en' => 'Placing a crown on a dental implant aims to restore the shape and function of the missing tooth. However, since the implant was placed elsewhere, there may be limited information about the status of the implant and surrounding tissues.',
                    'sort_order' => 10,
                ],
                [
                    'type' => 'instruction',
                    ...
                    'label_en' => 'Procedure Steps',
                    'options' => [
                        ['label_ar' => 'فحص الزرعة وتقييم حالتها ومدى اندماجها مع العظم.', 'label_en' => 'Examining the implant and evaluating its status and osseointegration with the bone.'],
                        ['label_ar' => 'تحضير الزرعة لتركيب التاج.', 'label_en' => 'Preparing the implant to place the crown.'],
                        ['label_ar' => 'أخذ طبعة (قالب) للزرعة لإرسالها إلى المختبر لتصنيع التاج.', 'label_en' => 'Taking an impression (mold) of the implant to send to the lab for crown fabrication.'],
                        ['label_ar' => 'تركيب التاج الدائم بعد الانتهاء من تصنيعه.', 'label_en' => 'Placing the permanent crown once fabrication is complete.'],
                    ],
                    'settings' => ['list_type' => 'numbered'],
                    'sort_order' => 20,
                ],
                [
                    ...
                    'options' => [
                        ['label_ar' => 'استعادة وظيفة المضغ والابتسامة.', 'label_en' => 'Restoring chewing function and smile.'],
                        ['label_ar' => 'تحسين المظهر الجمالي للفم.', 'label_en' => 'Improving the cosmetic appearance of the mouth.'],
                        ['label_ar' => 'استقرار الزرعة ودعمها بواسطة التاج.', 'label_en' => 'Implant stability and support by the crown.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 30,
                ],
                [
                    ...
                    'label_en' => 'Risks and Potential Complications',
                    'options' => [
                        ['label_ar' => 'حساسية مؤقتة في المنطقة المحيطة بالزرعة بعد الإجراء.', 'label_en' => 'Temporary sensitivity in the area surrounding the implant after the procedure.'],
                        ['label_ar' => 'احتمالية حدوث كسر أو تلف في التاج أو الزرعة.', 'label_en' => 'Potential breakage or damage to the crown or implant.'],
                        ['label_ar' => 'احتمالية حدوث التهاب أو عدوى في حال عدم الالتزام بتعليمات العناية الفموية.', 'label_en' => 'Potential for inflammation or infection if oral care instructions are not followed.'],
                        ['label_ar' => 'احتمالية وجود مشاكل غير مكتشفة في الزرعة قد تؤثر على نجاح التاج.', 'label_en' => 'Potential undetected issues in the implant that could affect crown success.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 40,
                ],
                [
                    ...
                    'label_ar' => 'التكهن الطبي',
                    'label_en' => 'Medical Prognosis',
                    'content_ar' => 'نظراً لأن الزرعة تم تركيبها خارج العيادة، قد تكون هناك معلومات محدودة عن حالتها ومدى اندماجها مع العظم. قد يؤثر ذلك على نجاح الإجراء وعمر التاج.',
                    'content_en' => 'Since the implant was placed elsewhere, there may be limited information about its status and osseointegration with the bone. This may affect the success of the procedure and lifespan of the crown.',
                    'sort_order' => 50,
                ],
                [
                    'type' => 'instruction',
                    ...
                    'label_en' => 'Available Alternatives',
                    'options' => [
                        ['label_ar' => 'تركيب جسر ثابت بدلاً من الزرعة.', 'label_en' => 'Placing a fixed bridge instead of the implant.'],
                        ['label_ar' => 'استخدام طقم أسنان جزئي أو كامل.', 'label_en' => 'Using a partial or complete denture.'],
                        ['label_ar' => 'عدم تركيب التاج، مع العلم أن ذلك قد يؤثر على وظيفة الزرعة والمظهر الجمالي.', 'label_en' => 'Not placing the crown, noting that this may affect implant function and cosmetic appearance.'],
                    ],
                    'settings' => ['list_type' => 'bullet'],
                    'sort_order' => 60,
                ],
                ...
                [
                    'type' => 'text',
                    'key' => 'implant_tooth_number',
                    'label_ar' => 'رقم الزرعة / السن المستهدف',
                    'label_en' => 'Implant / Tooth Location Number',
                    'placeholder_ar' => 'مثال: 16',
                    'placeholder_en' => 'e.g. 16',
                    'is_required' => true,
                    'settings' => ['width' => 'full'],
                ...
                [
                    ...
                    'content_ar' => 'أقر بأنني تلقيت شرحاً كافياً عن الإجراء، وأدرك أن الزرعة تم تركيبها خارج العيادة وقد تكون هناك معلومات محدودة عن حالتها، وأوافق على إجراء تركيب تاج على زرعة الأسنان.',
                    'content_en' => 'I acknowledge that I have received a sufficient explanation of the procedure, realize that the implant fixture was placed at another facility and there may be limited information about its status, and consent to place a crown on the dental implant.',
                    'sort_order' => 110,
                ],
                [
                    'type' => 'signature',
